...
export function AdminServiceDetailSkeleton() {
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      {/* Cover Image */}
      <div className="h-36 sm:h-56 bg-muted/20 animate-pulse" />

      {/* Service Info */}
      <div className="px-3 sm:px-6 pb-3 sm:pb-4 pt-1 sm:pt-2">
        <div className="h-8 w-64 sm:w-80 bg-muted/30 rounded animate-pulse mb-2" />
